      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-4 text-foreground">
            Professional <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-teal-600 dark:from-emerald-400 dark:to-teal-400">Experience</span>
          </h2>
        ...
        <div className="relative border-l border-border ml-4 md:ml-0 space-y-12">
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div className="bg-card border border-border/50 rounded-2xl p-6 md:p-8 hover:border-emerald-500/30 hover:shadow-[0_8px_30px_rgb(16,185,129,0.12)] dark:hover:shadow-[0_8px_30px_rgb(52,211,153,0.12)] hover:-translate-y-1 transition-all duration-300 group shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4 gap-4">
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold text-foreground group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                      {exp.title}
                    </h3>
                    <div className="flex items-center gap-2 text-teal-600 dark:text-teal-400 mt-1 font-medium">
